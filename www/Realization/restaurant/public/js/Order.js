...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function Actualiserdescription(idMeal) {
        ...
        ajaxPost('/www/Realization/restaurant/index.php?action=orderIdMeal', data, function (reponse) {
    ...
    boutonPasser.addEventListener('click', function (e) {
        ...
        if (tableau.length !== 0) {
            ...
            ajaxPost('/www/Realization/restaurant/index.php?action=ConfirmOrder', data, function (reponse) {
                ViderPanier();
            }, false);
