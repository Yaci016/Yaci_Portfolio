...
function ajax()
{
    ...
    if (isset($id)) {
        ...
        echo "<img src=\"/www/Realization/restaurant/public/images/meals/" . $premier_aliment['photo'] . "\" alt=\"" . $premier_aliment['name'] . "\">
...
function checkErrors()
{
    ...
    if (isset($_SESSION['Email_non_existant'])) {
        ...
        $message = 'echec de la connexion.l\'email fournis est inexistant dans la base de données.';

    };
    if (isset($_SESSION['logIn_fail'])) {
        unset($_SESSION['logIn_fail']);
        $message = 'echec de la connexion. Mauvais mot de passe.';
